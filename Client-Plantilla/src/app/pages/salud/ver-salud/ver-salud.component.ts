...
@Component({
  selector: 'app-ver-salud',
  templateUrl: './ver-salud.component.html',
  styleUrls: ['./ver-salud.component.scss']
})
export class VerSaludComponent implements OnInit {
