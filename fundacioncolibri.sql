...
--
-- Host: localhost
-- Generation Time: Apr 22, 2021 at 06:27 AM
...
CREATE TABLE `canton` (
  ...
  `descripcioncanton` longtext COLLATE utf8_unicode_ci,
...
--
-- Table structure for table `casaacogimiento`
--

CREATE TABLE `casaacogimiento` (
  `idnombrecasaanterior` int(11) NOT NULL,
  `descripcioncasaacogimiento` longtext COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `casaacogimiento`
--
...
--
-- Table structure for table `datosjudicialpenal`
--

CREATE TABLE `datosjudicialpenal` (
  `idjudicialpenal` int(11) NOT NULL,
  `idpersona` int(11) DEFAULT NULL,
  `idmedida` int(11) DEFAULT NULL,
  `idprovincia` int(11) DEFAULT NULL,
  `nºcausaacogimiento` varchar(150) CHARACTER SET utf8 DEFAULT NULL,
  `unidadjudicial` varchar(150) CHARACTER SET utf8 DEFAULT NULL,
  `idcanton` int(11) DEFAULT NULL,
  `idnudoscriticos` int(11) DEFAULT NULL,
  `existecausapenal` bit(1) DEFAULT NULL,
  `encuentrainsert@spavt` bit(1) DEFAULT NULL,
  `idinfracciondenunciada` int(11) DEFAULT NULL,
  `descripciondelito` longtext COLLATE utf8_unicode_ci,
  `nºcasofiscalia` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `nºprocesopenalesatje` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `idestadoprocesal` int(11) DEFAULT NULL,
  `egresoporreinsercion` bit(1) DEFAULT NULL,
  `fechareinsercion` date DEFAULT NULL,
  `fechaegreso` date DEFAULT NULL,
  `fecharesoluciontraslado` date DEFAULT NULL,
  `unidadtraslado` longtext COLLATE utf8_unicode_ci,
...
--
-- Table structure for table `datossalud`
--

CREATE TABLE `datossalud` (
  `iddatossalud` int(11) NOT NULL,
  `idpersona` int(11) DEFAULT NULL,
  `estadosalud` char(15) CHARACTER SET utf8 DEFAULT NULL,
  `detalleenfermedad` varchar(120) CHARACTER SET utf8 DEFAULT NULL,
  `medicacion` bit(1) DEFAULT NULL,
  `adolescenteperdiodogestacion` bit(1) DEFAULT NULL,
  `algunadiscapacidad` bit(1) DEFAULT NULL,
  `tipodiscapacidad` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `porcentajediscapacidad` varchar(6) CHARACTER SET utf8 DEFAULT NULL,
  `numerocarnet` varchar(40) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `estadoprocesal`
--

CREATE TABLE `estadoprocesal` (
  `idestadoprocesal` int(11) NOT NULL,
  `descripcionprocesal` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `estadoprocesal`
--
...
CREATE TABLE `etnia` (
  ...
  `descripcionetnia` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `familiarreferente`
--

CREATE TABLE `familiarreferente` (
  `idfamiliarreferente` int(11) NOT NULL,
  `descripcionfamiliarreferente` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `familiarreferente`
--
...
CREATE TABLE `genero` (
  ...
  `descripciongenero` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `historialcronologico`
--
...
CREATE TABLE `historialcronologico` (
  ...
  `idnombrecasaanterior` int(11) DEFAULT NULL,
  `fechaegreso` date DEFAULT NULL,
...
--
-- Table structure for table `infracciondenunciada`
--

CREATE TABLE `infracciondenunciada` (
  `idinfracciondenunciada` int(11) NOT NULL,
  `descripcioninfracciondenuncia` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `infracciondenunciada`
--
...
CREATE TABLE `medida` (
  ...
  `descripcionmedida` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `modalidad` (
  ...
  `descripcionmodalidad` varchar(50) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `motivoingreso` (
  ...
  `descripcionmotivoingreso` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `nacionalidad` (
  ...
  `descripcionnacionalidad` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `nivelacademico` (
  ...
  `descripcionacademico` varchar(50) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `nudoscriticos`
--

CREATE TABLE `nudoscriticos` (
  `idnudoscriticos` int(11) NOT NULL,
  `descripcionnudoscriticos` longtext COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `nudoscriticos`
--
...
CREATE TABLE `organizacion` (
  ...
  `descripcionorganizacion` longtext COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `parroquia` (
  ...
  `descripcionparroquia` longtext COLLATE utf8_unicode_ci,
  `idcanton` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `persona` (
  ...
  `documentoidentidad` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `idgenero` int(11) DEFAULT NULL,
  `idetnia` int(11) DEFAULT NULL,
  `idnacionalidad` int(11) DEFAULT NULL,
  `fechanacimiento` date DEFAULT NULL,
  `fecharegistro` datetime(6) DEFAULT NULL,
  `edad` char(3) CHARACTER SET utf8 DEFAULT NULL,
  `idprovincia` int(11) DEFAULT NULL,
  `idcanton` int(11) DEFAULT NULL,
  `idparroquia` int(11) DEFAULT NULL,
  `barrio` longtext COLLATE utf8_unicode_ci,
  `direccion` varchar(120) CHARACTER SET utf8 DEFAULT NULL,
  `fechadeingresounidadatencion` date DEFAULT NULL,
  `edadingreso` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
  `tiempopermanenciaaños` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `idmotivoingreso` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `pgf` (
  `idpgf` int(11) NOT NULL,
  `idperonsa` int(11) DEFAULT NULL,
  `idfamiliarreferente` int(11) DEFAULT NULL,
  `nombrefamiliar` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `idprovincia` int(11) DEFAULT NULL,
  `idcanton` int(11) DEFAULT NULL,
  `direccion` longtext COLLATE utf8_unicode_ci,
  `telefono` char(15) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `provincia` (
  ...
  `descripcionprovincia` longtext COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Indexes for table `casaacogimiento`
--
ALTER TABLE `casaacogimiento`
  ADD PRIMARY KEY (`idnombrecasaanterior`);

--
-- Indexes for table `datosjudicialpenal`
--
...
--
-- Indexes for table `estadoprocesal`
--
...
--
-- Indexes for table `familiarreferente`
--
...
--
-- Indexes for table `historialcronologico`
--
...
--
-- Indexes for table `infracciondenunciada`
--
...
--
-- Indexes for table `motivoingreso`
--
...
--
-- Indexes for table `nudoscriticos`
--
...
--
-- AUTO_INCREMENT for table `datosjudicialpenal`
--
ALTER TABLE `datosjudicialpenal`
  MODIFY `idjudicialpenal` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `datossalud`
--
ALTER TABLE `datossalud`
  MODIFY `iddatossalud` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `historialcronologico`
--
ALTER TABLE `historialcronologico`
...
--
-- AUTO_INCREMENT for table `pgf`
--
ALTER TABLE `pgf`
  MODIFY `idpgf` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `datosjudicialpenal`
--
ALTER TABLE `datosjudicialpenal`
...
--
-- Constraints for table `historialcronologico`
--
ALTER TABLE `historialcronologico`
